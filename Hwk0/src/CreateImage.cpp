 ...
 *
 * Should be able to pass in the image data file as a parameter.  I use:
 * ./Homework0 otherImageData.txt
 *
 * I built this in eclipse, If you have tips on what tools to use,
 * I'd be interested to hear it.  Could go straight commandline i suppose
 * Just don't know how to structure a program really.
 *
 */
...
int main( int argc, char *argv[] )
{
	...
	else
	{
		...
		inputFileName = "src/imageData.txt";
	}
